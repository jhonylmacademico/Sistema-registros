    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className='bg-white p-4 rounded-xl shadow-sm space-y-4'>
        ...
        {esImpresoraOSwitch ? (
          ...
          <>
            <div>
              ...
              <input name='asignadoA' value={form.asignadoA || ''} onChange={handleChange} required className='w-full p-3 border border-gray-300 rounded-lg bg-gray-50' placeholder='Nombre completo' />
            </div>
            <div>
              <label className='block text-sm font-medium text-gray-700 mb-1'>Departamento</label>
              <input name='departamento' value={form.departamento || ''} onChange={handleChange} className='w-full p-3 border border-gray-300 rounded-lg bg-gray-50' placeholder='Ej: Contabilidad' />
            </div>
            <div className='grid grid-cols-3 gap-2'>
              <div>
                <label className='block text-xs font-medium text-gray-700 mb-1'>Procesador</label>
                <input name='procesador' value={form.procesador || ''} onChange={handleChange} className='w-full p-3 border border-gray-300 rounded-lg bg-gray-50 text-sm' placeholder='i5 10ma' />
              </div>
              <div>
                <label className='block text-xs font-medium text-gray-700 mb-1'>RAM</label>
                <input name='ram' value={form.ram || ''} onChange={handleChange} className='w-full p-3 border border-gray-300 rounded-lg bg-gray-50 text-sm' placeholder='8GB' />
              </div>
              <div>
                <label className='block text-xs font-medium text-gray-700 mb-1'>Almacenamiento</label>
                <input name='almacenamiento' value={form.almacenamiento || ''} onChange={handleChange} className='w-full p-3 border border-gray-300 rounded-lg bg-gray-50 text-sm' placeholder='256GB' />
              </div>
            </div>
          </>
        )}
        ...
        <div>
          ...
          <textarea name='notas' value={form.notas || ''} onChange={handleChange} rows='2' className='w-full p-3 border border-gray-300 rounded-lg bg-gray-50' placeholder='Cualquier detalle adicional...'></textarea>
        </div>
        ...
        <div className='flex gap-3 pt-2'>
          ...
          {activo && (
            <button type='button' onClick={handleEliminar} className='bg-red-100 text-red-600 px-4 rounded-lg font-bold'><Trash2 size={20} /></button>
          )}
        </div>
      </form>
    </div>
