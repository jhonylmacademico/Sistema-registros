        ...
        {centroActual && vista === 'reporte' && (
          <div className='space-y-4'>
            <div className='bg-white p-4 rounded-xl shadow-sm'>
              <h2 className='font-bold text-gray-800 mb-3'>1. Selecciona qué columnas quieres:</h2>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <button onClick={exportarCSV} className='bg-green-600 text-white p-4 rounded-xl font-bold flex items-center justify-center gap-2 shadow-sm'><Download size={20} /> Excel</button>
              <button onClick={exportarPDF} className='bg-red-600 text-white p-4 rounded-xl font-bold flex items-center justify-center gap-2 shadow-sm'><FileText size={20} /> PDF</button>
            </div>
  ...
  return (
    <div className='bg-green-50 p-3 rounded-lg border-l-4 border-green-400 space-y-3'>
      ...
      <label className='flex items-center gap-3 p-3 bg-white rounded-lg border-2 border-indigo-200 cursor-pointer'>
        ...
        <div>
          <span className='font-bold text-indigo-700'>Marcar como "En Almacén" (Sin asignar)</span>
          <p className='text-xs text-gray-500'>Activa esto si el equipo no tiene usuario aún.</p>
        </div>
      </label>
